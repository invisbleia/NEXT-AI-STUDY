      ...
      <div className="relative z-10 p-4 sm:p-6 lg:p-8">
        <main className="max-w-5xl mx-auto">
          ...
          <header className="text-center my-16 animate-fade-in-up" style={{ animationDelay: '100ms' }}>
            ...
            <button onClick={onNavigateToTenseApp} className="mt-8 inline-block bg-blue-600 text-white font-semibold px-8 py-3 rounded-lg shadow-lg shadow-blue-500/30 hover:bg-blue-500 transition-all hover:-translate-y-1">
              Explore AI Tools
            </button>
          </header>
          ...
          <section id="tools" className="my-24 animate-fade-in-up" style={{ animationDelay: '200ms' }}>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                  ...
                  <FeatureCard 
                      ...
                      description="Generate practice questions, get detailed answer explanations, and simulate exam conditions."
                      comingSoon
                  />
                  <FeatureCard 
